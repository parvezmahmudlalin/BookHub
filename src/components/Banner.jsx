...
const Banner = () => {
  return (
    <div className="bg-[url('https://images.unsplash.com/photo-1524995997946-a1c2e315a42f')] h-[60vh] w-full bg-cover bg-center flex items-center rounded-lg shadow-xl">
